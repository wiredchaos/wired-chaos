...
const GrantsForFounders = () => {
  ...
  const modules = [
    {
      ...
      quiz: ['What is the key difference between a grant and a loan?', 'Name three types of grant sources'],
    },
    {
      id: 'module-2',
      ...
      quiz: ['What are the three main eligibility factors?', 'How do tags help with grant matching?'],
    },
    {
      id: 'module-3',
    ...
    },
    {
      ...
      quiz: ['What are the key components of a grant application?', 'How do you write an effective budget justification?'],
    },
    {
      id: 'module-5',
    ...
    },
    {
      ...
      quiz: ['How can you monitor application status?', 'What should you do if your application is rejected?'],
    },
    {
      id: 'module-7',
      ...
      quiz: ['What made the successful applications stand out?', 'Name three key learnings from case studies'],
    }
  ];
  ...
  return (
    <div className="grants-edu-container" style={{ padding: '40px', minHeight: '100vh', background: '#000' }}>
      {/* Header */}
  ...
  return (
    <div className="module-detail" style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <Card style={{ padding: '40px', background: '#1a1a2e', border: '2px solid #00FFFF' }}>
        ...
        <h2 style={{ color: '#00FFFF', fontSize: '32px', marginBottom: '20px' }}>
          {module.title}
        </h2>
        
        <div style={{ marginBottom: '30px' }}>
          <h3 style={{ color: '#39FF14', fontSize: '20px', marginBottom: '15px' }}>
            Lessons:
          </h3>
  ...
  const upsells = [
    {
      ...
      icon: '🎯',
      description: 'Work directly with our grant experts to develop a personalized grant strategy for your organization.',
    ...
    },
    {
      ...
      icon: '🤖',
      description: 'Automate your grant discovery, application drafting, and submission process with our AI-powered SWARM system.',
    ...
    },
    {
      ...
      icon: '🏢',
      description: 'Deploy a fully branded grant management platform for your organization or clients.',
